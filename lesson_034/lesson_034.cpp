//Делегирующие конструкторы c++. Вызов конструктора из конструктора. ООП. С++ Для начинающих. #107 - Видео 40.
...
public:
	...
	void Print() const // Указывает, что этот метод не изменяет состояние объекта, на котором он вызывается.
	{
		cout << "Имя: " << Name << endl;
...
Пишем Human h("Аристарх"); мы просто указали имя, и он его запишет. 
Потомучто есть конструктор с одинм таким условием :Human(Name)
