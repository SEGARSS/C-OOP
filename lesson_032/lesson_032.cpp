//Виртуальный деструктор класса C++. Что это такое. Наследование. Полиморфизм. Для начинающих #105 - Видео №38.
...
//----------------------------------------------------------------------------
/*
Очень эфективный способ подчистки памяти. Если мы сылкой идём с одного конструктора на другой, не указав virtual,
у нас пойдёт утечкав памяти. Тоесть, в данной строке - A *bptr = new B; мы обращаемся к объекту B через указатель,
чистим память delete bptr;, но из за того что не указали virtual в классе, чиста только там и будет, а в классе 
произойдёт утечка.
