//Что такое класс. Что такое объект класса. Экземпляр класса это. Класс ООП это. Урок #73 - Видео №86.
...
/*Также важно помнить, создаль клас к примеру class Human, мы его используем уже в теле под многие переменные,
под многие данные.
